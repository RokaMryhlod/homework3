...
// якщо довжини стічок рівні або false в іншому випадку. - fixed
...
// 14.1 Ускладнена умова. Функція приймає другим параметром Boolean(true/false). 
...
// 15. Написати функцію reverse, яка приймає стрічку і виводить її в зворотньому порядку. 
// Тобто я передаю ‘qwerty’, а маю отримати ‘ytrewq’;
